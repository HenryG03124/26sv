...
model.load_state_dict(torch.load(SCRIPT_DIR / "pc_model_v2_bdd100k.pth" , map_location = device , weights_only = True))
model.eval()
...
mask_image.save(SCRIPT_DIR / "test_mask_v2_bdd100k.png")

print("mask saved: test_mask_v2_bdd100k.png")
